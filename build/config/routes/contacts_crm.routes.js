...
exports.ContactCrmRoutes = void 0;
...
class ContactCrmRoutes extends common_routes_config_1.CommonRoutesConfig {
    constructor(api) {
        super(api, "ContactCrmRoutes", "crm");
    }
    configureRoutes() {
        // this.api.route("/v1/crm/hubspot/v2/contacts/:email")
...
exports.ContactCrmRoutes = ContactCrmRoutes;
